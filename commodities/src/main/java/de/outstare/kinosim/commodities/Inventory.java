...
public class Inventory {
	private final Map<Goods, AtomicInteger> goodCounts = new HashMap<>();
	...
	public int getAmount(final Goods good) {
	...
	public void add(final Goods good, final int amount) throws InventoryFullException {
	...
	public void remove(final Goods good, final int amount) {
		if (goodCounts.containsKey(good)) {
	...
	public boolean isFree(final Goods good, final int amount) {
